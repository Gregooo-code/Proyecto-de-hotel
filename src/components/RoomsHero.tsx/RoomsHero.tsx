...
export const RoomsHero = () => {
  ...
  const stats = [
    ...
    { icon: <Award className="w-5 h-5" />, value: "50+", label: "Habitaciones" },
    { icon: <Users className="w-5 h-5" />, value: "10K+", label: "Huéspedes" },
  ];
      ...
      <div className="relative z-10 px-6 max-w-5xl mx-auto">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-md rounded-full text-white/80 text-sm hover:bg-white/20 transition-all duration-300">
            ...
            <span className="text-white font-medium">Habitaciones & Suites</span>
          </div>
        </motion.div>
        ...
        >
          Descubre el <span className="text-[#F20C1F] font-semibold">confort</span> y la{" "}
          <span className="text-[#F20C1F] font-semibold">elegancia</span> en cada rincón de tu estancia.
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-white/70 text-xs group-hover:text-white/90">{stat.label}</div>
              </div>
            </div>
          ))}
        </motion.div>
